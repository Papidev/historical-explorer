...
AI markdown generated from the Wikipedia snapshot lives as `.md` files in `data/wiki-ai/`. Unlike the generated source snapshots, this is a reviewable content artifact and should be committed after AI generation and human editing.
